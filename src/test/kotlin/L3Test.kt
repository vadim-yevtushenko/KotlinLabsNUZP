...
internal class L3Test(
    private val task: TaskL3, private val seed: String,
    private val simulationObject: FactoryItf
) {
    ...
    fun test1() {
        ...
        when (task.theme) {
            L3Theme.JUICE_FABRIC -> testJuiceFabric1()
            L3Theme.CAFFE -> testCafee1()
        }
        simulationObject.resetSimulation()
        assertTrue(simulationObject.getLeftovers().isEmpty(), "Склад має бути порожнім після сбросу симуляції.")
    }

    private fun testJuiceFabric1() {
    ...
    fun test2() {
        ...
        assertTrue(simulationObject.getLeftovers().isEmpty(), "Склад має бути порожнім після сбросу симуляції.")
        when (task.theme) {
            L3Theme.JUICE_FABRIC -> testJuiceFabric2()
            L3Theme.CAFFE -> testCafee2()
        }
    }
